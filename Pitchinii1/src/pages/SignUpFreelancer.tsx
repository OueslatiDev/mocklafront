...
interface FileFormData {
  link: string;
  type: string;
  userId: string; // Vous devrez peut-être changer ce type selon votre implémentation
  file: File;
}
      ...
      <main className="self-stretch flex flex-row items-start justify-center py-0 pr-[21px] pl-5 box-border max-w-full">
        ...
        <Login1
          ...
          <FrameComponent
            ...
            onFreelacerTextClick={onFreelacerTextClick}
